...
Param(
    ...
    [string[]] $Tags = "CFSummit,Bosh,Windows"
)
begin{
...
$Req = Invoke-WebRequest -Uri $InstallerJsonUrl -Method Get -UseBasicParsing
...
Invoke-WebRequest -Uri $TargetMSI -OutFile $MSI -Method Get -UseBasicParsing
